...
def trajectory(points, t, fig, classes):
    '''
...
def graphGenerator(x_0, y_0, fig):
    '''
...
def graphing(x_0, y_0, permutation):
    '''
...
def encrypt_gammaP(plain_text, matrix):
    """
...
def decrypt_gammaP(cipher_text, matrix):
    """
